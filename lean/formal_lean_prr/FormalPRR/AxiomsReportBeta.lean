...
A3 (CrossoverBounds), A5 (B0ChainKernel), A6 (BudgetThreshold).
(2026-09-23, item L1: the companion-kernel sections A4 SeedConditioning and
A5 NewtonKernel moved to FormalPRRCompanion/AxiomsReportCompanion.lean.)
